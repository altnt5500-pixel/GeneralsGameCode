...
enum
{
	...
	STEALTH_NOT_WHILE_FIRING_QUATERNARY	= 0x00000040,
	STEALTH_NOT_WHILE_FIRING_QUINARY		= 0x00000080,
	STEALTH_ONLY_WITH_BLACK_MARKET			= 0x00000100,
	STEALTH_NOT_WHILE_TAKING_DAMAGE			= 0x00000200,
  STEALTH_NOT_WHILE_RIDERS_ATTACKING  = 0x00000400,

	STEALTH_NOT_WHILE_FIRING_WEAPON			= (STEALTH_NOT_WHILE_FIRING_PRIMARY | STEALTH_NOT_WHILE_FIRING_SECONDARY | STEALTH_NOT_WHILE_FIRING_TERTIARY | STEALTH_NOT_WHILE_FIRING_QUATERNARY | STEALTH_NOT_WHILE_FIRING_QUINARY),
};
